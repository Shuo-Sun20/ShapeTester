...
try:
    result_eager = call_func(inputs_eager, axis=0)
...
x_placeholder = keras.Input(shape=(3, 4))
weights_placeholder = keras.Input(shape=(4,))
inputs_placeholder = [x_placeholder, weights_placeholder]

try:
    result_placeholder = call_func(inputs_placeholder, axis=0)
